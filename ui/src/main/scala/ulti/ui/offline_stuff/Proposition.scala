...
sealed trait PartyProposition extends Proposition
...
sealed trait GeneralBetliProposition extends Proposition {
  override val incompatibleWith: Proposition => Boolean = proposition => {
...
sealed trait GeneralDurchmarsProposition extends Proposition {
  override val incompatibleWith: Proposition => Boolean = proposition => {
    proposition.isInstanceOf[GeneralBetliProposition] ||
    proposition == SimpleProposition
  }
...
sealed trait GeneralPlainDurchmarsProposition extends GeneralDurchmarsProposition {
