...
object Bid {
  implicit val schema: Schema[Bid] = DeriveSchema.gen
  implicit val codec: JsonCodec[Bid] = zio.schema.codec.JsonCodec.jsonCodec(schema)
...
object CombinableBid {
  implicit val schema: Schema[CombinableBid] = DeriveSchema.gen
  implicit val codec: JsonCodec[CombinableBid] = zio.schema.codec.JsonCodec.jsonCodec(schema)
}
